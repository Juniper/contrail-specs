...
Each appformix flow server is represented as a flow-node object in VNC database.
Objects to represent collector parameters such as virtual IP address
are added to the vnc schema. Underlay telemetry infra subnet is modelled for supporting
