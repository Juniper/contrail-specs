...
- CVFM accepts static list of supported DVSes in its config file
- Topology change requires CVFM plugin restart/reprovision (in case of changed list of supported DVSes)
