...
```
{
  "job_template_fq_name": ["default-global-system-config", "rma_activate_existing_template"],
  "input": {
    "serial_number": <serial_number_str>
  }
  "device_list": [<device_uuid>]
...
- New physical_router.managed_state field with these values: "rma", "activating", "active"
- New physical_router.underlay_config field to store underlay config of brownfield device
...
from the device and stored on the physical_router.underlay_config field in the VNC database,
...
# 15. Testing
https://drive.google.com/open?id=1eahuSTstXQ3Gb8_UJf8HyR_vOWJV7Tfo
