...
- New fabric.fabric_wide_vlan_significance boolean field with these values: 
...
- New fabric.fabric_wide_vlan_significance attribute to select between enterprise-style
