...
# 3. Proposed solution
Monitor individual bond members and send an alarm to analytics to display the current link status of Master/Slave bond members in contrail GUI under Cluster -> Cluster Nodes -> Compute Nodes -> (ComputeName) -> Detailed stats -> Alarms.
