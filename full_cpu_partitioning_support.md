...
8. Results
----------
Test   Description                             PPS with drops <0.01% per core    PPS without drops per core
----   -----------                             ------------------------------    --------------------------
1      Regular vRouter binary from 1910 with     0.5 to 1 Mpps (variable)         0.5 to 1 Mpps (variable) 
       isolcpus enabled on nova only
2      Modified (private) 1908 vRouter binary    1.85Mpps (stable)                1.84Mpps (stable)
       with above recommendations applied
