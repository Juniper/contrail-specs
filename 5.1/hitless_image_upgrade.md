...
The user needs to have information about all the devices that are in maintenence maode.  Hence there might be a requirement to introduce a new field in the PhysicalRouter object to capture the 'state' of the device.
