...
contrail-container-builder will be added with two new containers one is mesos manager and other \
...
contrail control components on master. Orchestration will be mesos but no mesos components would be \
